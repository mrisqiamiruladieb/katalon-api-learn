...
response = WS.sendRequest(findTestObject('Authorization/Register', [('baseUrl') : GlobalVariable.baseUrl]))
...
'Assert Response Body Contains ID = 4'
...
println("Stored token: " + GlobalVariable.token)